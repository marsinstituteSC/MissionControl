        ...
        while self.running:
            ...
            if ret2:
                if VIDEO2_COLOR == "True":
                    ...
                    grey_image2 = cv2.cvtColor(frame1, cv2.COLOR_BGR2GRAY)
                    convert_to_qt_format1 = QImage(grey_image2.data, grey_image2.shape[1], grey_image2.shape[0], QImage.Format_Grayscale8)
                    p1 = convert_to_qt_format1.scaled(640, 480, Qt.KeepAspectRatio)
                    self.changePixmap1.emit(p1)
